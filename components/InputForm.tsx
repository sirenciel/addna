...
export const InputForm: React.FC<InputFormProps> = ({ onGenerate }) => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
        ...
        console.error("Kesalahan membaca file:", error);
  ...
  return (
    <div className="max-w-4xl mx-auto bg-brand-surface rounded-xl shadow-2xl p-8">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-brand-text-primary">Mulai Dengan Satu Iklan Referensi</h2>
          ...
          <div className="flex flex-col h-full space-y-4">
            <div>
              ...
              <textarea
                ...
                placeholder="Contoh: Capek ngepel lantai terus-terusan? Coba pembersih lantai X, sekali usap langsung kinclong!"
                value={caption}
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-gray-900 border border-gray-700 rounded-md p-3 focus:ring-2 focus:ring-brand-primary focus:border-brand-primary transition-colors disabled:opacity-50"
                placeholder="Contoh: Pembersih lantai organik dengan aroma lavender, aman untuk anak dan hewan peliharaan."
                value={productInfo}
             ...
             <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-gray-900 border border-gray-700 rounded-md p-3 focus:ring-2 focus:ring-brand-primary focus:border-brand-primary transition-colors disabled:opacity-50"
                placeholder="Contoh: Beli 1 gratis 1 hanya hari ini! Klik link di bio untuk membeli."
                value={offerInfo}
